...
namespace OfflineSiteMonitoringTool.Repository.Tests
{
    ...
    public class GetOfflineReportFromAddressTests
    {
        ...
        [TestMethod]
        public void GetOfflineReportFromAddress_NoValueExistsInConfigFile_ThrowsError()
        {
            // Have mock replicate the error that would be generated by the config file not having this value specified.
            // mockConfigHelper.Setup(x => x.GetFromAddress()).Throws(new ConfigurationErrorsException());
            
            // TODO: Not sure if this test is worth mocking the repository to catch a pretty simple error
        }
    }
}
